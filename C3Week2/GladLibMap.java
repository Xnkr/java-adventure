...
public class GladLibMap {
    ...
    private void initializeFromSource(String source) {
        ...
        String[] categories = {"country","noun","animal","adjective", "name", "color", 
    ...
    private String getSubstitute(String label) {
        int idx = usedCategories.indexOf(label);
        if(idx == -1)
    ...
    public void makeStory(){
        ...
        printOut(story, 60);
        System.out.println("\nTotal Replacements: "+ usedWords.size());
        int total = totalWordsInMap();
        System.out.println("Total: "+total); 
        total = totalWordsConsidered();
    ...
    private int totalWordsInMap(){
        ...
        for( String s : myMap.keySet()){
            System.out.println("Total number of "+ s+ " available: "+myMap.get(s).size());
